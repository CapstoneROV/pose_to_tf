...
void cloudCallback(const sensor_msgs::PointCloud2ConstPtr& cloud_msg, tf2_ros::Buffer *tfBuffer, ros::Publisher* pub) {
    ...
    try {
        ...
        geometry_msgs::TransformStamped transformStamped = 
            tfBuffer->lookupTransform("map", "ping360_link", cloud_msg->header.stamp, ros::Duration(3.0));
...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub = nh.subscribe<sensor_msgs::PointCloud2>("/corrected_frame_cloud", 1, 
